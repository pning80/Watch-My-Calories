...
App Store Connect setup guides, screenshots, and metadata organized by version.

## Structure

```
AppStore/
├── V1.0.0/              # Version 1.0.0 (2026-03-08)
│   ├── Set-Up.md        # App Store Connect setup guide
...
│   ├── AppIcon.png      # App icon (1024×1024)
│   └── Screenshots/     # App Store screenshots
├── V1.4.1/              # Version 1.4.1 (2026-04-03)
│   ├── Set-Up.md        # App Store Connect update guide
│   ├── AppIcon.png      # App icon (1024×1024)
│   └── Screenshots/     # App Store screenshots
