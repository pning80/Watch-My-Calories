...
fun AboutScreen(onNavigateBack: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // AI disclaimer (mirror of iOS About screen `generated by AI` copy).
            Text(
                "Calorie and macro estimates are generated by AI and may not be accurate. Always consult a registered dietitian for medical or nutritional advice.",
