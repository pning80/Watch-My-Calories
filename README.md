...
### iOS App
All the source code is located in the CalorieWatcher sub-folder. Just open the CalorieWatcher XCode project and you can get started.

### Android App
All the source code is located in the CalorieWatcherAndroid sub-folder. Open the CalorieWatcherAndroid project in Android Studio and you can get started.
